...
describe('Client metadata validation', () => {
  ...
  context('introspection_signed_response_alg', function () {
    const configuration = { features: { introspection: true } };
  ...
  context('features.encryption', () => {
    const configuration = { features: { encryption: true, introspection: true } };
  ...
  context('jwks', function () {
    const configuration = { features: { introspection: true, revocation: true, encryption: true } };
